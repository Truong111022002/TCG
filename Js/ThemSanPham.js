...
const thanhtoan = document.getElementById('btn-buy');
function buy(){
    alert("Thanh toán thành công số tiền: " +formatCurrency(Math.floor(total*1.1)));
}

thanhtoan.addEventListener('click',buy);